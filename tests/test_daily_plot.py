...
def test_daily_figure_shows_used_active_achievements_in_two_bands():
    achievements = [
        Achievement("walk", "Walk", "movement", "#111111", "#444444", "#777777", "walk"),
        Achievement("run", "Run", "movement", "#222222", "#555555", "#888888", "run"),
        Achievement("cooked", "Cooked", "food", "#333333", "#666666", "#999999", "cooked"),
    ]
    records = [
    ...
    serialized = json.loads(cast(str, build_daily_figure(records, achievements).to_json()))
...
def test_daily_figure_supports_empty_data_without_empty_achievement_rows():
    achievement = Achievement("walk", "Walk", "movement", "#111111", "#444444", "#777777", "walk")
    figure = build_daily_figure([], [achievement])
...
def test_active_days_figure_counts_inactive_movement_but_not_food():
    ...
    serialized = json.loads(cast(str, build_active_days_figure(records, achievements).to_json()))
...
def test_active_days_figure_supports_no_movement_data():
    cooked = Achievement("cooked", "Cooked", "food", "#333333", "#666666", "#999999", "cooked")
